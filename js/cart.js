    ...
    template: `
        <div class="buy" @click="isVisibleCart = !isVisibleCart">
            ...
            <div class="cartWindow" @click.stop :class="{visible: isVisibleCart, invisible: !isVisibleCart}">
                ...
                <button v-if="productsInCart.length" class="goToCartbtn" @click="goToCheckout">CHECKOUT</button>
                <button v-if="productsInCart.length" class="clearCart" @click="goToCart">GO TO CART</button>
